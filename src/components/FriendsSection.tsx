...
const FriendsSection = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-100 to-lavender-100 p-6">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-purple-800 text-center mb-8 uppercase">FRIENDS</h1>

        <div className="grid grid-cols-3 md:grid-cols-5 gap-6 mb-8">
          {friends.map((friend) => (
            <Card
              key={friend.id}
              className="bg-white/60 backdrop-blur-sm border-pink-200 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group hover:scale-105"
        ...
        <div className="text-center mt-8">
          <Card className="bg-white/60 backdrop-blur-sm border-pink-200 p-6 rounded-2xl shadow-lg max-w-2xl mx-auto">
